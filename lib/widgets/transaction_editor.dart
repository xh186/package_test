...
class _TransactionEditorState extends State<TransactionEditor> {
  ...
  void initState() {
    ...
    _category = item?.category ?? _expenseCategories.first;
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 14),
                  TextFormField(controller: _note, maxLength: 120, decoration: const InputDecoration(labelText: '备注（选填）')),
                  ...
                  SizedBox(
                    ...
                    child: FilledButton.icon(
                      onPressed: () {
                        ...
                        Navigator.pop(context, TransactionDraft(type: _type, amount: double.parse(_amount.text), category: _category, note: _note.text.trim(), date: _date));
                      },
